...
<html lang="en">
 ...
 <!-- Add List -->
 <div class="input">
    <?php echo "<h3>Search results for ".$_GET['search']."</h3>";?>
 </div>
 <!-- Tabel -->
 <div class="output">
  <table class="table" id="myTable">
    ...
    <tbody>
      <?php
        //Serial Number
        $query = mysqli_query($user,"select * from Listdetails");
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
          ...
          if(isset($_POST['EditTitle']))
          {
              ...
              if(!empty($EditSno) and !empty($Title) and !empty($Description))
              {
                ...
                {
                  header("location: //localhost/To%20Do%20List/SearchPage.php?search=$search");
                }
              }
          }
        }
        ...
        { 
            ...
            $searchupper = strtoupper($_GET['search']);
            $query = "select * from Listdetails where Title like'%$searchlower%' or Title like'%$searchupper%' or Description like '%$searchlower%' or Description like '%$searchupper%'";
...
<script>
    ...
    function func()
    {
      window.location = "//localhost/To%20Do%20List/SearchPage.php?logout=true";
    }
    ...
    function fundelete(e)
    {
       if(confirm('Do you want to delete data'))
       {
          ...
          window.location = `//localhost/To%20Do%20List/SearchPage.php?DeleteElement=${child}&search=<?php echo$_GET['search'];?>`;
       }
    }
